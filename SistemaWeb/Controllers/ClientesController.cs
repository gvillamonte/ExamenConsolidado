...
namespace SistemaWeb.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClienteId,Nombre,Email")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClienteId,Nombre,Email")] Clientes clientes)
        {
            if (ModelState.IsValid)
            {
